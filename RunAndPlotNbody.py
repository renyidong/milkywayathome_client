...
os.system("cmake -DNBODY_OPENCL=OFF -DDOUBLEPREC=ON -DNBODY_OPENMP=OFF -DCMAKE_BUILD_TYPE=RELEASE")
os.system('make')
executeString = './bin/milkyway_nbody -f nbody/sample_workunits/EMD_10k_plummer.lua -o CPUBRUTE.out -z CPU.hist -x -i -e 12693 ' + str(timesteps) + ' 1 .2 12' #>> CPUACCTEST.out'
